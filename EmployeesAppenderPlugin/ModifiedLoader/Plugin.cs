...
{ 
  ...
  [Author(Name = "Ivan Petrov Modidfied by Rageon")]
  public class Plugin : IPluggable
  {
    private static readonly NLog.Logger logger = NLog.LogManager.GetCurrentClassLogger();
    public IEnumerable<DataTransferObject> Run(IEnumerable<DataTransferObject> args)
    {
      logger.Info("Loading employees from resources");

      var source = args.Cast<EmployeesDTO>().ToList();
      ...
      return employeesList.Concat(source).ToList().Cast<DataTransferObject>();
    }
  }
}
